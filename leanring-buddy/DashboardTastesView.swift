    ...
    private var tastesListView: some View {
        DashboardContentScrollContainer {
            DashboardSectionHeader(
                ...
                subtitle: "Each taste is a person's soul, voice, and the principles Sticky has learned. Click yours to edit. Click a teammate to read."
            )
    ...
    private func personaCard(forBundle bundle: PersonaBundle, isYours: Bool) -> some View {
        Button(action: {
            ...
            HStack(spacing: ElevenLabsBrand.Spacing.md) {
                PersonaAvatarView(avatar: bundle.avatar, diameter: 56)
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text("\(bundle.taste.principles.count) principle\(bundle.taste.principles.count == 1 ? "" : "s")")
