...
- **AI chat**: OpenAI GPT-5.2 is the default for voice, typed chat, Teach analysis, and onboarding; Claude Haiku/Sonnet/Opus remain optional. Provider-specific Cloudflare Worker routes stream SSE responses.
...
- **OpenAI GPT-5.2 is the default model.** Claude Haiku/Sonnet/Opus remain pickable. Model preferences use the `selectedAIModel` UserDefaults key.
