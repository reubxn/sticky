/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=sticky-onboarding-dev` (hash: f621677f55e67a10f501e946b8a8cb7f)
...
interface __BaseEnv_Env {
	...
	WORKER_HMAC_CURRENT_KEY_ID: string;
	WORKER_HMAC_CURRENT_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONVEX_SITE_URL" | "ELEVENLABS_VOICE_ID" | "ONBOARDING_ROUTES_ENABLED" | "ANTHROPIC_API_KEY" | "ASSEMBLYAI_API_KEY" | "ELEVENLABS_API_KEY" | "WORKER_HMAC_CURRENT_KEY_ID" | "WORKER_HMAC_CURRENT_KEY">> {}
}
